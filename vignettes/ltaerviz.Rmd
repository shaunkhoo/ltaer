...
In the example below, I link the bus stop availability data with 

## 5. Next Steps

Visualising spatial data is more challenging because you have to work with more moving parts (basemap, coordinates, spatial objects). Yet, it is also incredibly rewarding when you produce a good spatial visualisation that communicates your message effectively and looks great. Try both `ggmap` and `leaflet` out and see how it goes for you.

If you are still stuck as to how you might visualise some of the data provided by LTA's APIs, here are some suggestions which you can consider taking up:
